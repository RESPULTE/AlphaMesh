"""
api/persistence/base.py

Abstract persistence adapter for conversation storage.

Swapping SQLite for Redis, PostgreSQL, or any other backend only requires
implementing this interface — no changes to the ConversationStore service
or any router code.
"""
