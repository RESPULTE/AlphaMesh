...
class Settings(BaseSettings):
    ...
    RETRIEVAL_TRACE_AUTO_EXPORT: bool = True
    ...
    TAVILY_SEARCH_MAX_RESULTS: int = 1
    TAVILY_SEARCH_DEPTH: str = "basic"
    TAVILY_TOPIC: str = "news"

    NEWS_AGENT_MAX_RESEARCH_ITERATIONS: int = 2
    NEWS_AGENT_MIN_RELEVANCE_SCORE: float = 0.20
    NEWS_WORKING_MEMORY_MAX_CHUNKS: int = 30
    NEWS_WORKING_MEMORY_SEEN_URL_CAP: int = 10
    NEWS_WORKING_MEMORY_SEEN_CHUNK_CAP: int = 30
    ...
    GRAPH_ALLOW_CREATE_SOURCES: str = "taxonomy_bootstrap"
