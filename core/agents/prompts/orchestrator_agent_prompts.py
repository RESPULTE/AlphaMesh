...
These contexts are generated by each agent from its own summaries.
Use them only to preserve continuity when selecting `target_agents` and writing `per_agent_queries`.
