...
from app.auth import handle_auth_dialog, set_auth_mode_and_show_modal
import os
import logging
...
def _display_hero_section():
    ...
    with st.container():
        ...
        with col1:
            ...
            st.write(
                "AlphaMesh uses a team of specialized AI agents to analyze markets, debate strategies, and deliver clear, actionable investment intelligence. No code, just results."
            )
            if st.button(
                "Get Started for Free", key="hero_get_started", type="primary"
            ):
                set_auth_mode_and_show_modal("Sign Up")
        with col2:
...
def _display_social_proof_section():
    ...
    with st.container():
        ...
        logos = [
            {
                "path": "https://upload.wikimedia.org/wikipedia/commons/d/d9/Google_Gemini_logo_2025.svg",
                "caption": "Google Gemini",
            },
            {
                "path": "https://upload.wikimedia.org/wikipedia/commons/6/60/LangChain_Logo.svg",
                "caption": "LangChain",
            },
            {
                "path": "https://upload.wikimedia.org/wikipedia/commons/c/ca/Interactive_Brokers_Logo_%282014%29.svg",
                "caption": "Interactive Brokers",
            },
            {
                "path": "https://upload.wikimedia.org/wikipedia/commons/3/3a/Yahoo%21_%282019%29.svg",
        ...
        for i, logo in enumerate(logos):
            with cols[i]:
                st.image(
                    logo["path"], caption=logo["caption"], use_column_width="always"
                )
...
def _display_how_it_works_section():
    ...
    with st.container():
        st.header(
            "From Market Noise to Actionable Thesis in 3 Steps", divider="rainbow"
        )
        ...
        cards_data = [
            {
                ...
                "text": "Tell AlphaMesh your investment style and risk tolerance. Your AI team calibrates to your specific needs.",
            },
            {
                "icon": "2.",
                "title": "Agents Analyze & Debate",
                "text": "Our AI agents—a Risk Analyst, a News Sentinel, a Fundamental Analyst—gather data and debate the best course of action.",
            },
            {
                "icon": "3.",
                "title": "Receive Your Briefing",
                "text": "Get a clear, synthesized report with bull and bear cases, key data points, and a final recommendation. All transparent, all for you.",
            },
        ]
...
def _display_features_section():
    ...
    with st.container():
        ...
        with col1:
            ...
            st.write(
                "Start your day with a mission-critical summary. Your agent team works 24/7, so you wake up with insights, not just alerts. Get a curated look at your portfolio's overnight news, market sentiment, and the top opportunity identified by the mesh."
            )
        with col2:
        ...
        with col1:
            st.image(
                "https://placehold.co/500x300/1a1a1a/FFFFFF?text=Transparent+Analysis"
            )
        with col2:
            st.header("Deep Dive with Full Transparency")
            st.write(
                "Every insight is backed by transparent reasoning. Understand the 'why' behind each recommendation by exploring the Bull Case from the Fundamental Agent, the Bear Case from the Risk Manager, and citations from the News Sentinel."
            )
...
def _display_final_cta():
    ...
    with st.container(border=True):
        ...
        st.write(
            "Stop guessing. Start making data-driven decisions with your personal AI investment committee."
        )
